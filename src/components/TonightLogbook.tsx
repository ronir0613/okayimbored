...
export default function TonightLogbook() {
  ...
  return (
    <div className="min-h-screen bg-black text-white/90 font-sans px-8 py-24 sm:py-32 flex flex-col items-center selection:bg-white/20 selection:text-white cursor-default">
      <div className="w-full max-w-3xl flex flex-col items-start gap-12 text-xl sm:text-3xl font-light tracking-wide leading-relaxed">
